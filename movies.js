...
let	b = document.querySelectorAll(".drama");
let	c = document.querySelectorAll(".action");
let	d = document.querySelectorAll(".image-display-action");
	
let allbtn = document.getElementById("all");
let	dramabtn = document.getElementById("drama");
let	actionbtn = document.getElementById("action");
let	scifibtn = document.getElementById("scifi");
let	type = document.querySelector("#filter");
let page = document.querySelector(".found");
